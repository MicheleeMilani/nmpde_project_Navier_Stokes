...
mesh-all:
	$(GMSH) $(MESH_DIR)/turek.geo -2 -format msh2 -o $(MESH_DIR)/turek.msh
	$(GMSH) $(MESH_DIR)/turek_lite.geo -2 -format msh2 -o $(MESH_DIR)/turek_lite.msh
	$(GMSH) $(MESH_DIR)/turek_super_lite.geo -2 -format msh2 -o $(MESH_DIR)/turek_super_lite.msh
	$(GMSH) $(MESH_DIR)/Cylinder3D.geo -3 -format msh2 -o $(MESH_DIR)/Cylinder3D.msh
